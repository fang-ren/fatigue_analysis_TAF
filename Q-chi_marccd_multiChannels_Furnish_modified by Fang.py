...
############ code starts here #############
###########################################
folder_path = 'P:\\bl11-3\\May2016\\NiFe_scans\\test\\'
base_filename = 'large_zinger_'
...
while (1):
    ...
    for i in range(len(chiList)):
        if IntAve_total[i] > (3*criterion +4):
            zinger += 1
    
    # https://github.com/CrakeNotSnowman/Python_Message/blob/master/sendMessage.py
    if zinger > 2:
        print 'Multiple 3-sigma anomalous spot was found in file ' + base_filename + str(file_index)[2:] + ', sending level-1 alert...'
        print("\r\n")
        fromaddr = 'hitpxrd@gmail.com'
        #toaddrs1 = '2036688741@pm.sprint.com'
        toaddrs2  = '5052214328@vzwpix.com'
        toaddrs3  = 'tfurnish22@gmail.com'
        msg = "\r\n".join([
        "From: hitpxrd@gmail.com"
        "To: 5052214328@vzwpix.com, tfurnish22@gmail.com",
        "Subject: Multiple 3-sigma ALERT",
        "",
        "Multiple 3-sigma anomalous spots were found in file " + base_filename + str(file_index)[2:]
        ])
        ...
        print '2 3-sigma anomalous spot were found in file ' + base_filename + + str(file_index)[2:] + ', sending level-1 alert...'
        print("\r")
        fromaddr = 'hitpxrd@gmail.com'
        toaddrs2  = '5052214328@vzwpix.com'
        toaddrs3  = 'tfurnish22@gmail.com'
        ...
        "From: hitpxrd@gmail.com"
        "To: 5052214328@vzwpix.com, tfurnish22@gmail.com",
        "Subject: Two 3-sigma ALERT",
        "",
        "Two 3-sigma anomalous spots were found in file " + base_filename + str(file_index)[2:]
        ])
        username = 'hitpxrd@gmail.com'
        password = 'HiTpXRD2016'
        server = smtplib.SMTP('smtp.gmail.com:587')
