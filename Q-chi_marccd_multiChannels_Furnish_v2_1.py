...
file_index = 0.0002
basefile_indexed = base_filename + str(file_index)
...
while (1):
    ...
    if IntAveMax > (6+3*criterion):
        print 'a 5-sigma anomalous spot was found in file %s...sending level-1 alert...' % basefile_indexed
        print("\r\n")
        ...
        "",
        "A 5-sigma anomalous spot was found in file %s" % base_filename
        ])
        ...
        print 'a 3-sigma anomalous spot was found in file %s...sending level-1 alert...' % base_filename
        print("\r")
        fromaddr = 'hitpxrd@gmail.com'
        toaddrs2  = '5052214328@vzwpix.com'
        toaddrs3  = 'tfurnish22@gmail.com'
        ...
        "",
        "A 3-sigma anomalous spot was found in file %s" % base_filename
        ])
        username = 'hitpxrd@gmail.com'
        password = 'HiTpXRD2016'
        server = smtplib.SMTP('smtp.gmail.com:587')
    ...
    # not sure whose number this is... I removed it so I'm not bombarding anyone else with text messages. 
    #2036688741@messaging.sprintpcs.com
