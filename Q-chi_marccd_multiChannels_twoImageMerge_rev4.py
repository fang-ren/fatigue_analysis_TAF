...
############ code starts here #############
###########################################
folder_path = 'P:\\bl11-3\\May2016\\NiFe_scans\\NiFe-W4-db15-after95unloaded\\control_ZatN1and1\\'  
base_filename = 'NiFeW4db15-after95kUnloaded_ThN30to30_ZN1_Z1_05211044_'
...
#plt.pcolormesh(Q, chi, imArray)) # not plotting zero intensities
#plt.colorbar()
#plt.xlim((3.12, 3.16))
...
while (1):   
    ...
    for i in range(len(chiList)):
        if IntAve_total[i] > 4.3:
            zinger += 1
    
    # https://github.com/CrakeNotSnowman/Python_Message/blob/master/sendMessage.py
    # Brad's iphone info:  '5053663332@vzwpix.com'
    # Tim's iphone info: '5052214328@vzwpix.com'
    # Dan's iphone info: '5052353175@vzwpix.com'
    ...
    if zinger > 1:
        ...
        toaddrs1  = '5052214328@vzwpix.com'
        toaddrs2  = '5052353175@vzwpix.com'
        msg = "\r\n".join([
        "From: hitpxrd@gmail.com"
        "To: 5052214328@vzwpix.com, 5052353175@vzwpix.com",
